...
import { addSuccess, find, findAll, findAllPageable, removeSuccess, resetUser, setErrors, setPaginator, updateSuccess } from "../users/users.actions";
...
export const usersReducer = createReducer(
    ...
    on(addSuccess, (state, {userNew}) => ({
        users: [...state.users, {...userNew}], // Se recupera de user-app.component.ts
        paginator: state.paginator,
        user: {... user},
        errors: {},
        loading: state.loading
